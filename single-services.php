...
/*
Template for displaying Services pages
*/
		...
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				if( function_exists('have_rows')):
					...
					// this industry page has no children then find solutions associated with it
					// pull only solutions that are children of a solution that has the same title
					//as this industry page
					if(empty($children_array)):
						...
						if($solution_page_parent != ''):
								...
								$pullthis['meta_query']				= array(
									'relation' => 'OR',
									array(
										'key'		=> 'exclude_from_service_landing_page',
										'value'	=> '1',
										'compare'	=> '!='
									),
									array(
					...
					//if this services is not a parent of any other services,
					// the solutions area will have links to Topic (solution) pages not other services pages
					if($associated_category == 0):
						$s_title = 'Solutions';
					else:
										...
										?>
												<div class="col-xs-12 col-sm-6 col-md-6">
													<a href="<?php echo get_permalink($article_post->ID) ?>" class="cwf-card">
														...
														<div class="excerpt black-text"><?php echo cwf_create_short_excerpt($blurb, 156); ?></div>
